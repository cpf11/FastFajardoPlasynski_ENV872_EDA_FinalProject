...
knitr::kable(total_summary_lamb, caption = "Table 3:Summary Statistics of Lamb Dataset")
...
knitr::kable(summary_lambratio, caption = "Table 4: Lamb EWE Ratio: Summary Table")
```
